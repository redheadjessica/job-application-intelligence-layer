...
```
.venv/bin/python3 ENGINE__PUBLIC_GIT_TRACKED/04-TAILOR/cover-letter/make_cover_letter_docx.py path/to/letter.md -o "path/to/Cover-Letter-Draft - Company - Role.docx"
```
