...
def main() -> None:
    ...
    print(f'  .venv/bin/python3 ENGINE__PUBLIC_GIT_TRACKED/02-PREP/prep.py "{src_rel}" --input "{urls_rel}"')
    ...
    print(f'  .venv/bin/python3 ENGINE__PUBLIC_GIT_TRACKED/02-PREP/prep.py "{src_rel}" --input "{urls_rel}" --engine playwright')
