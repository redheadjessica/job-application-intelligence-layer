...
- **Next up (Unit 4):** prep reliability (dedupe, collision-safe filenames, thin/failed detect + quarantine, manifest, chat summary, retry).
- **Later V2B/C units:** candidate-relative ranking/coloring; archive + reconcile UX; README/public-page + screenshots + diagram.
