...
- **Next up (Unit 6):** archive + reconcile UX (move-not-copy, readiness check, PDF-missing warning, cadence, workspace-leftover warning).
- **Later V2C units:** README/public-page + screenshots + diagram.
