...
- **Next up (Unit 5):** candidate-relative ranking/coloring (colorizer reads `jail.config.json`; lane-aware ranking).
- **Later V2C units:** archive + reconcile UX; README/public-page + screenshots + diagram.
