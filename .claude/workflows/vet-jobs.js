...
// norm_contracts.py is the ONE canonical normalizer (no JS port): it enforces the canonical
// Working Location grammar on the CSV in place, printing every repair, BEFORE the XLSX build.
const NORM_SCHEMA = {
