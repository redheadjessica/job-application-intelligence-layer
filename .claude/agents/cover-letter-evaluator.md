...
**`PRIVATE__YOUR_FILES_GITIGNORED/04-TAILOR__YOUR_PRIVATE_INFO/cover-letter/eval-rubric.md`** (the candidate's private instance; if it's missing,
...
Also read, in order: `PRIVATE__YOUR_FILES_GITIGNORED/04-TAILOR__YOUR_PRIVATE_INFO/cover-letter/voice-spec.md`,
`PRIVATE__YOUR_FILES_GITIGNORED/04-TAILOR__YOUR_PRIVATE_INFO/cover-letter/feedback-ledger.md` (newest wins), the exemplars in
`PRIVATE__YOUR_FILES_GITIGNORED/04-TAILOR__YOUR_PRIVATE_INFO/cover-letter/exemplars/` (GOLD + any NEGATIVE at minimum), the job `.txt`, and the
...
- **Truthfulness spot-check is part of Fit:** flag any claim you can't trace to the application
  ...
  `PRIVATE__YOUR_FILES_GITIGNORED/04-TAILOR__YOUR_PRIVATE_INFO/cover-letter/writing-links.md`, and any violation of
